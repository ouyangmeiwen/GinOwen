...
func(s AutoService) CusAutoMigrate() {
	...
	err = DB.AutoMigrate(&model.Bookcaseinfo{})

	if err != nil {
		log.Fatalf("Failed to migrate table: Bookcaseinfo")
		return
	}
	...
	err = DB.AutoMigrate(&model.Itemloc010301{})

	if err != nil {
		log.Fatalf("Failed to migrate table: Itemloc010301")
		return
	}
	err = DB.AutoMigrate(&model.Item{})

	if err != nil {
		log.Fatalf("Failed to migrate table: Item")
		return
	}
	...
	err = DB.AutoMigrate(&model.Libpointrobot{})

	if err != nil {
		log.Fatalf("Failed to migrate table: Libpointrobot")
		return
	}
	...
	err = DB.AutoMigrate(&model.Libshelfpoint{})

	if err != nil {
		log.Fatalf("Failed to migrate table: Libshelfpoint")
		return
	}
	...
	err = DB.AutoMigrate(&model.OwenAuditlog{})

	if err != nil {
		log.Fatalf("Failed to migrate table: OwenAuditlog")
		return
	}
	err = DB.AutoMigrate(&model.OwenRole{})

	if err != nil {
		log.Fatalf("Failed to migrate table: OwenRole")
		return
	}
	err = DB.AutoMigrate(&model.OwenScheduledtask{})

	if err != nil {
		log.Fatalf("Failed to migrate table: OwenScheduledtask")
		return
	}
	err = DB.AutoMigrate(&model.OwenUser{})

	if err != nil {
		log.Fatalf("Failed to migrate table: OwenUser")
		return
	}
