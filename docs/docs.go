...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/services/app/FlyRead/GetEnableStruct": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.FlyReadEnableStruct"
                                            }
                                        },
                                        "msg": {
                                            "type": "string"
        ...
        "/api/services/app/FlyRead/GetStructTreeList": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.StructDto"
                                            }
                                        },
                                        "msg": {
                                            "type": "string"
        ...
        "/api/services/app/FlyRead/InventoryFlyReadIndex": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.InventoryFlyReadIndexInput"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.InventoryFlyReadIndexDto"
                                            }
                                        },
                                        "msg": {
                                            "type": "string"
    ...
    "definitions": {
        ...
        "request.InventoryFlyReadIndexInput": {
            "type": "object"
        },
        ...
        "response.InventoryFlyReadHisDto": {
            "type": "object",
            "properties": {
                "FaultNums": {
                    "type": "integer"
        ...
        "response.InventoryFlyReadIndexDto": {
            "type": "object",
            "properties": {
                "Current": {
                    "$ref": "#/definitions/response.InventoryFlyReadHisDto"
                },
                "Last": {
                    "$ref": "#/definitions/response.InventoryFlyReadHisDto"
                }
