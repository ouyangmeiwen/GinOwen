...
const TableNameLibcirculatelog = "libcirculatelog"

// Libcirculatelog mapped from table <libcirculatelog>
...
// TableName Libcirculatelog's table name
func (*Libcirculatelog) TableName() string {
	return TableNameLibcirculatelog
}
