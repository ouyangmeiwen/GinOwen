...
type Libpatron struct {
	...
	DepositMoney         int64      `gorm:"column:DepositMoney;type:int(11);not null" json:"DepositMoney"`
	Balance              int64      `gorm:"column:Balance;type:int(11);not null" json:"Balance"`
	LateFee              int64      `gorm:"column:LateFee;type:int(11);not null" json:"LateFee"`
