...
const TableNameLibitemCopy = "libitem_copy"

// LibitemCopy mapped from table <libitem_copy>
...
// TableName LibitemCopy's table name
func (*LibitemCopy) TableName() string {
	return TableNameLibitemCopy
}
