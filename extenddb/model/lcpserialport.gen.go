...
const TableNameLcpserialport = "lcpserialport"

// Lcpserialport mapped from table <lcpserialport>
...
func (*Lcpserialport) TableName() string {
	return TableNameLcpserialport
}
