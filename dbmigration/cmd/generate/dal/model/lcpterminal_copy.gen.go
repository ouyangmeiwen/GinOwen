...
const TableNameLcpterminalCopy = "lcpterminal_copy"

// LcpterminalCopy mapped from table <lcpterminal_copy>
...
// TableName LcpterminalCopy's table name
func (*LcpterminalCopy) TableName() string {
	return TableNameLcpterminalCopy
}
