...
type Libailibrarainknowledgefileinfo struct {
	...
	FileName             string     `gorm:"column:FileName;type:varchar(48);not null" json:"FileName"`
	...
	ContentType          *string    `gorm:"column:ContentType;type:varchar(120)" json:"ContentType"`
