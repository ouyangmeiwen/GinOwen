...
const TableNameAppsubbookinfo = "appsubbookinfo"

// Appsubbookinfo mapped from table <appsubbookinfo>
...
// TableName Appsubbookinfo's table name
func (*Appsubbookinfo) TableName() string {
	return TableNameAppsubbookinfo
}
