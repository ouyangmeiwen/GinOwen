...
const TableNameSysauditacslog = "sysauditacslog"

// Sysauditacslog mapped from table <sysauditacslog>
...
// TableName Sysauditacslog's table name
func (*Sysauditacslog) TableName() string {
	return TableNameSysauditacslog
}
