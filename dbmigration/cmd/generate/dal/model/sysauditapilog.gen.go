...
const TableNameSysauditapilog = "sysauditapilog"

// Sysauditapilog mapped from table <sysauditapilog>
...
// TableName Sysauditapilog's table name
func (*Sysauditapilog) TableName() string {
	return TableNameSysauditapilog
}
