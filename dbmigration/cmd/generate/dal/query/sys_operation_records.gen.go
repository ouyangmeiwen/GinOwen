...
func newSysOperationRecord(db *gorm.DB) sysOperationRecord {
	_sysOperationRecord := sysOperationRecord{}

	_sysOperationRecord.sysOperationRecordDo.UseDB(db)
...
type ISysOperationRecordDo interface {
	...
	Create(values ...*model.SysOperationRecord) error
	CreateInBatches(values []*model.SysOperationRecord, batchSize int) error
	Save(values ...*model.SysOperationRecord) error
	First() (*model.SysOperationRecord, error)
	Take() (*model.SysOperationRecord, error)
	Last() (*model.SysOperationRecord, error)
	Find() ([]*model.SysOperationRecord, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.SysOperationRecord, err error)
	FindInBatches(result *[]*model.SysOperationRecord, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.SysOperationRecord) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.SysOperationRecord, error)
	FirstOrCreate() (*model.SysOperationRecord, error)
	FindByPage(offset int, limit int) (result []*model.SysOperationRecord, count int64, err error)
