...
func newDjangoSession(db *gorm.DB) djangoSession {
	_djangoSession := djangoSession{}

	_djangoSession.djangoSessionDo.UseDB(db)
...
type djangoSession struct {
	djangoSessionDo djangoSessionDo
...
func (d *djangoSession) WithContext(ctx context.Context) IDjangoSessionDo {
	return d.djangoSessionDo.WithContext(ctx)
}

func (d djangoSession) TableName() string { return d.djangoSessionDo.TableName() }

func (d djangoSession) Alias() string { return d.djangoSessionDo.Alias() }
