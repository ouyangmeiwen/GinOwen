...
func newAuthPermission(db *gorm.DB) authPermission {
	_authPermission := authPermission{}

	_authPermission.authPermissionDo.UseDB(db)
	...
	_authPermission.ID = field.NewInt64(tableName, "id")
	_authPermission.Name = field.NewString(tableName, "name")
	_authPermission.ContentTypeID = field.NewInt64(tableName, "content_type_id")
...
type authPermission struct {
	authPermissionDo authPermissionDo
...
func (a *authPermission) updateTableName(table string) *authPermission {
	...
	a.ContentTypeID = field.NewInt64(table, "content_type_id")
...
func (a *authPermission) WithContext(ctx context.Context) IAuthPermissionDo {
	return a.authPermissionDo.WithContext(ctx)
}

func (a authPermission) TableName() string { return a.authPermissionDo.TableName() }

func (a authPermission) Alias() string { return a.authPermissionDo.Alias() }
