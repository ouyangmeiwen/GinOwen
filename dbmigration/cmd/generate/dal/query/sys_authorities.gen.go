...
func newSysAuthority(db *gorm.DB) sysAuthority {
	...
	_sysAuthority.sysAuthorityDo.UseDB(db)
	...
	_sysAuthority.DeletedAt = field.NewField(tableName, "deleted_at")
...
type sysAuthority struct {
	...
	AuthorityName field.String // 角色名
...
func (s sysAuthorityDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ISysAuthorityDo {
