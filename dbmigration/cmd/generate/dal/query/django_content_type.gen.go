...
func newDjangoContentType(db *gorm.DB) djangoContentType {
	_djangoContentType := djangoContentType{}

	_djangoContentType.djangoContentTypeDo.UseDB(db)
	...
	_djangoContentType.ID = field.NewInt64(tableName, "id")
...
type djangoContentType struct {
	djangoContentTypeDo djangoContentTypeDo
...
func (d *djangoContentType) WithContext(ctx context.Context) IDjangoContentTypeDo {
	return d.djangoContentTypeDo.WithContext(ctx)
}

func (d djangoContentType) TableName() string { return d.djangoContentTypeDo.TableName() }

func (d djangoContentType) Alias() string { return d.djangoContentTypeDo.Alias() }
