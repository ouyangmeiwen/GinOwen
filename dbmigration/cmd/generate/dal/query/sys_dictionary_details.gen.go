...
func newSysDictionaryDetail(db *gorm.DB) sysDictionaryDetail {
	_sysDictionaryDetail := sysDictionaryDetail{}

	_sysDictionaryDetail.sysDictionaryDetailDo.UseDB(db)
	...
	_sysDictionaryDetail.Extend = field.NewString(tableName, "extend")
...
type ISysDictionaryDetailDo interface {
	...
	Create(values ...*model.SysDictionaryDetail) error
	CreateInBatches(values []*model.SysDictionaryDetail, batchSize int) error
	Save(values ...*model.SysDictionaryDetail) error
	First() (*model.SysDictionaryDetail, error)
	Take() (*model.SysDictionaryDetail, error)
	Last() (*model.SysDictionaryDetail, error)
	Find() ([]*model.SysDictionaryDetail, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.SysDictionaryDetail, err error)
	FindInBatches(result *[]*model.SysDictionaryDetail, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.SysDictionaryDetail) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.SysDictionaryDetail, error)
	FirstOrCreate() (*model.SysDictionaryDetail, error)
	FindByPage(offset int, limit int) (result []*model.SysDictionaryDetail, count int64, err error)
