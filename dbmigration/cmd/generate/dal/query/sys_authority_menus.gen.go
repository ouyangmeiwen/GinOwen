...
func newSysAuthorityMenu(db *gorm.DB) sysAuthorityMenu {
	_sysAuthorityMenu := sysAuthorityMenu{}

	_sysAuthorityMenu.sysAuthorityMenuDo.UseDB(db)
...
func (s sysAuthorityMenuDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ISysAuthorityMenuDo {
