...
func newDjangoAdminLog(db *gorm.DB) djangoAdminLog {
	_djangoAdminLog := djangoAdminLog{}

	_djangoAdminLog.djangoAdminLogDo.UseDB(db)
	...
	_djangoAdminLog.ID = field.NewInt64(tableName, "id")
	...
	_djangoAdminLog.ActionFlag = field.NewInt64(tableName, "action_flag")
	_djangoAdminLog.ChangeMessage = field.NewString(tableName, "change_message")
	_djangoAdminLog.ContentTypeID = field.NewInt64(tableName, "content_type_id")
	_djangoAdminLog.UserID = field.NewInt64(tableName, "user_id")
...
type djangoAdminLog struct {
	djangoAdminLogDo djangoAdminLogDo
	...
	ActionFlag    field.Int64
	ChangeMessage field.String
	ContentTypeID field.Int64
	UserID        field.Int64
...
func (d *djangoAdminLog) updateTableName(table string) *djangoAdminLog {
	...
	d.ActionFlag = field.NewInt64(table, "action_flag")
	d.ChangeMessage = field.NewString(table, "change_message")
	d.ContentTypeID = field.NewInt64(table, "content_type_id")
...
func (d *djangoAdminLog) WithContext(ctx context.Context) IDjangoAdminLogDo {
	return d.djangoAdminLogDo.WithContext(ctx)
}

func (d djangoAdminLog) TableName() string { return d.djangoAdminLogDo.TableName() }

func (d djangoAdminLog) Alias() string { return d.djangoAdminLogDo.Alias() }
