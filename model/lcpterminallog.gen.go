...
type Lcpterminallog struct {
	...
	Business            int64     `gorm:"column:Business;type:tinyint(3) unsigned;not null" json:"Business"`
	TerminalLogType     int64     `gorm:"column:TerminalLogType;type:tinyint(3) unsigned;not null" json:"TerminalLogType"`
